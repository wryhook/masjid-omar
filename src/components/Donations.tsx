...
const Donations: React.FC = () => {
    return (
        <section id="donations" className="py-32 px-5 bg-foreground flex flex-col items-center justify-center">
            <p className="text-xl tracking-wider text-center text-white">DONATIONS</p>

            <div className="relative text-center z-10 max-w-lg md:max-w-5xl mt-12">
            ...
            <Link href="#cta" className="mt-12 text-primary font-medium bg-white border-2 border-white hover:border-white hover:bg-primary hover:text-white px-8 py-3 transition-colors">
                Donate
            </Link>
        </section>
    )
